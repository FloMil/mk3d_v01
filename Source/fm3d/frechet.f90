...
!print *, do_interface_partials
!  print *, 'glob_inv_index',glob_inv_index
!  print *, 'ray%source%start_index',ray%source%start_index
!  print *, 'source%start_index',source%start_index
